...
@section('title', __('global.key_features'))
...
<div class="d-flex justify-content-between align-items-center">
    <p>{{ __('global.desc_of_key_features_settings') }}</p>
</div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group" id="keyfeatures">
                        @if (count($keyfeatures)>0)
                        @foreach ($keyfeatures as $key => $keyfeature )
                        <li class="list-group-item draggable" data-id='{{ $keyfeature['id'] }}'>
                            <div class="media d-flex align-items-center">
                                <div class="dropdown mr-25">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('settings.keyfeatures.edit', $keyfeature['id'])  }}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{ __('global.edit') }}</span>
                                        </a>
                                        <a class="dropdown-item" onclick="deleteKeyfeature({{ $keyfeature['id'] }})">
                                ...
                                <span class="fa-stack fa-1x">
                                    ...
                                    <strong class="fa-stack-1x text-light">{{$keyfeature->order}}</strong>
                                </span>
                                <div class="media-body">
                                    <h5 class="my-1 ml-1">{!! $keyfeature->{'title:'.$grid_lang} !!}</h5>
                                </div>
                            </div>
                        </li>
                        @endforeach
...
<x-admin::scripts :files="[
        ...
        'js/custom/settings/keyfeatures/index.js',
    ]" />
@endsection
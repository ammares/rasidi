    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="javascript:void(0);" class="brand-logo">
          <!-- <svg id="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="233.2"
            height="39.7" viewBox="0 0 233.2 39.7">
            <defs>
          ...
          <img src="{{asset('storage/logo/logo.png')}}" class="rounded-circle mr-2" alt="img-placeholder" height="70" width="70"/>
        </a>
        ...
        <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
          ...
          <div class="form-group">
            <h6 for="login-email" class="form-label">{{ __('global.email') }}</h6>
          ...
          <div class="form-group">
            <div class="d-flex justify-content-between">
              <h6 for="login-password">{{ __('global.password') }}</h6>
          ...
          <div class="form-group">
            <div class="custom-control custom-checkbox">
              ...
              <h6 class="custom-control-label" for="remember-me"> {{ __('global.remember_me') }} </h6>
            </div>
          </div>
          <button type="submit" class="btn btn-primary btn-block" tabindex="4">{{ __('global.sign_in') }}</button>
        </form>
